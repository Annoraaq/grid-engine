...
var uh = ve((WC, ah) => {
  ...
  function CT(a5, e, r) {
    ...
    var T2 = Ce.guessLength(r);
    return T2 !== null && T2 < e && (e = T2), d = new Array(e), s = 0, gn(r, function(C) {
      s < e ? d[s] = C : (s === e && br(o, d), o(C, d[0]) > 0 && Wr(o, d, C)), s++;
  ...
  function _T(a5, e, r) {
    ...
    var T2 = Ce.guessLength(r);
    return T2 !== null && T2 < e && (e = T2), d = new Array(e), s = 0, gn(r, function(C) {
      s < e ? d[s] = C : (s === e && br(a5, d), a5(C, d[0]) > 0 && Wr(a5, d, C)), s++;
...
var ph = ve((zC, fh) => {
  ...
  function _a(a5, e) {
    var r = [], o = [], s = 2 * e / 3 | 0, u = e - s, h = s + 1 >> 1, p = s, d = 0, T2, C = [], E = [];
    if (e === 1) return [0];
    for (; p--; ) r[p] = (p * 3 >> 1) + 1;
    for (p = 3; p--; ) lh(a5, r, p);
    ...
    for (lh(a5, o, 0), p = 0, d = 0, T2 = 0; p < s && d < u; ) E[T2++] = LT(a5, C, r[p], o[d]) < 0 ? r[p++] : o[d++];
    for (; p < s; ) E[T2++] = r[p++];
    for (; d < u; ) E[T2++] = o[d++];
    return E;
  }
...
var bh = ve((qC, vh) => {
  ...
  Q2.prototype.reallocate = function(a5) {
  ...
  typeof Symbol != "undefined" && (Q2.prototype[Symbol.iterator] = Q2.prototype.values);
  Q2.prototype.inspect = function() {
    var a5 = this.array.slice(0, this.length);
    return a5.type = this.array.constructor.name, a5.items = this.length, a5.capacity = this.capacity, Object.defineProperty(a5, "constructor", { value: Q2, enumerable: false }), a5;
  };
  typeof Symbol != "undefined" && (Q2.prototype[/* @__PURE__ */ Symbol.for("nodejs.util.inspect.custom")] = Q2.prototype.inspect);
  Q2.from = function(a5, e, r) {
  ...
  function Le(a5) {
    ...
    for (var r in Q2.prototype) Q2.prototype.hasOwnProperty(r) && (e.prototype[r] = Q2.prototype[r]);
    return e.from = function(o, s) {
      return Q2.from(o, a5, s);
    }, typeof Symbol != "undefined" && (e.prototype[Symbol.iterator] = e.prototype.values), e;
  }
  Q2.Int8Vector = Le(Int8Array);
  Q2.Uint8Vector = Le(Uint8Array);
  Q2.Uint8ClampedVector = Le(Uint8ClampedArray);
  Q2.Int16Vector = Le(Int16Array);
  Q2.Uint16Vector = Le(Uint16Array);
  Q2.Int32Vector = Le(Int32Array);
  Q2.Uint32Vector = Le(Uint32Array);
  Q2.Float32Vector = Le(Float32Array);
  Q2.Float64Vector = Le(Float64Array);
  Q2.PointerVector = Le(DT);
  vh.exports = Q2;
});
var P = class a {
  static get ZERO() {
...
var kt = ((T2) => (T2.NONE = "none", T2.LEFT = "left", T2.UP_LEFT = "up-left", T2.UP = "up", T2.UP_RIGHT = "up-right", T2.RIGHT = "right", T2.DOWN_RIGHT = "down-right", T2.DOWN = "down", T2.DOWN_LEFT = "down-left", T2))(kt || {});
...
var Gb = { up: P.UP, down: P.DOWN, left: P.LEFT, right: P.RIGHT, none: P.ZERO, "up-left": P.UP_LEFT, "up-right": P.UP_RIGHT, "down-right": P.DOWN_RIGHT, "down-left": P.DOWN_LEFT };
...
function Cl(a5, e, r) {
  ...
  function p(I, G) {
    o[I] && (s[I] = function(k) {
      return new Promise(function(X2, nt) {
        u.push([I, k, X2, nt]) > 1 || d(I, k);
      });
    }, G && (s[I] = G(s[I])));
  }
  function d(I, G) {
  ...
  function T2(I) {
    I.value instanceof mr ? Promise.resolve(I.value.v).then(C, E) : B(u[0][2], I);
  }
  function C(I) {
    d("next", I);
  }
...
function Bl(a5, e, r, o, s, u, h, p) {
  var d = [], T2 = 0, C = 0, E = false, B = function() {
    E && !d.length && !T2 && e.complete();
  }, I = function(k) {
    return T2 < o ? G(k) : d.push(k);
  }, G = function(k) {
    u && e.next(k), T2++;
    var X2 = false;
    Vt(r(k, C++)).subscribe(zt(e, function(nt) {
...
function pa(a5, e, r) {
  return r === void 0 && (r = 1 / 0), K(e) ? pa(function(o, s) {
...
var gr = class gr2 {
  ...
  getFramesForCharIndex(e, r) {
    var T2;
    let o = Math.floor(r / this.charsInRow), s = r % this.charsInRow, u = this.charsInRow * gr2.FRAMES_CHAR_ROW, h = gr2.FRAMES_CHAR_ROW * s, p = ((T2 = this.directionToFrameRow[e]) != null ? T2 : 0) + o * gr2.FRAMES_CHAR_COL, d = h + p * u;
...
var xe = class {
  ...
  hasBlockingCharFrom(e, r, o, s, u, h, p) {
    ...
    let d = (C) => p.hasBlockingChar(C, r.layer, u, h), T2 = Pt(e.position, r.position);
  ...
  hasBlockingTileFrom(e, r, o, s, u, h) {
    ...
    let p = Pt(e.position, r.position), d = (T2) => h.hasBlockingTile(T2, r.layer, p, u);
...
var bn = class extends xe {
  ...
  shortestPathBfs(e, r) {
    var E, B, I;
    let o = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Map(), u = /* @__PURE__ */ new Map(), h = new Mi((G, k) => {
      var X2, nt;
      return ((X2 = u.get(G.id)) != null ? X2 : Number.MAX_VALUE) - ((nt = u.get(k.id)) != null ? nt : Number.MAX_VALUE);
    }), p = e, d = this.distance(e.position, r.position), T2 = 0, C = this.getNodeId(e);
    for (h.push({ node: e, id: C }), s.set(C, 0), u.set(C, this.distance(e.position, r.position)); h.size > 0; ) {
      let G = h.pop();
      if (!G) break;
      let k = G.node, X2 = G.id;
      T2++;
      let nt = this.distance(k.position, r.position);
      if (nt < d && (d = nt, p = k), xh(k, r)) return { previous: o, closestToTarget: p, steps: T2, maxPathLengthReached: false };
      if (((E = s.get(X2)) != null ? E : Number.MAX_VALUE) + 1 > this.options.maxPathLength) return { previous: /* @__PURE__ */ new Map(), closestToTarget: p, steps: T2, maxPathLengthReached: true };
      for (let $t of this.getNeighbors(k, r)) {
        let bt = this.getNodeId($t), fe = ((B = s.get(X2)) != null ? B : Number.MAX_VALUE) + this.getCosts(k.position, $t);
...
var zr = class extends xe {
  ...
  shortestPathBfs(e, r) {
    ...
    for (u.enqueue({ node: e, dist: 0 }), s.add(W.toString(e)); u.size() > 0; ) {
      let T2 = u.dequeue();
      if (d++, !T2) break;
      let { node: C, dist: E } = T2;
      if (E > this.options.maxPathLength) return { previous: /* @__PURE__ */ new Map(), closestToTarget: h, steps: d, maxPathLengthReached: true };
      let B = this.distance(C.position, r.position);
      if (B < p && (p = B, h = C), this.equal(C, r)) return { previous: o, closestToTarget: h, steps: d, maxPathLengthReached: false };
      for (let I of this.getNeighbors(C, r)) s.has(W.toString(I)) || (o.set(W.toString(I), C), u.enqueue({ node: I, dist: E + 1 }), s.add(W.toString(I)));
    }
...
var xn = class extends xe {
  ...
  shortestPathBfs(e, r) {
    ...
    let o = (C) => this.getNodeId(C), s = new Pn(o), u = new Pn(o), h = 0;
    ...
    for (s.queue.enqueue({ node: e, dist: 0 }), u.queue.enqueue({ node: r, dist: 0 }), s.visited.set(this.getNodeId(e), 0), u.visited.set(this.getNodeId(r), 0); this.shouldStop(s.queue.size() > 0, u.queue.size() > 0); ) {
      ...
      if (!C) break;
      let { node: E, dist: B } = C;
      if (B + 1 + (((T2 = u.queue.peek()) == null ? void 0 : T2.dist) || 0) > this.options.maxPathLength) return { previous: s.previous, previous2: u.previous, closestToTarget: this.maybeClosestToTarget(p), steps: h, maxPathLengthReached: true };
      ...
      if (!G) continue;
      let { node: k, dist: X2 } = G;
      if (h++, u.step(this.getReverseNeighbors(k, r), k, X2), u.isNewFrontier() && u.minMatchingNode) return { previous: s.previous, previous2: u.previous, closestToTarget: this.maybeClosestToTarget(r), matchingPos: u.minMatchingNode, steps: h, maxPathLengthReached: false };
    }
...
var $r = class extends xe {
  ...
  shortestPath(r, o) {
    ...
    this.g = /* @__PURE__ */ new Map(), this.f = /* @__PURE__ */ new Map(), this.closestToTarget = r, this.smallestDistToTarget = this.distance(r.position, o.position), this.openSet = new Mi((T2, C) => {
      var E, B;
      return ((E = this.f.get(T2.id)) != null ? E : Number.MAX_VALUE) - ((B = this.f.get(C.id)) != null ? B : Number.MAX_VALUE);
    });
    ...
    for (this.openSet.push({ node: r, id: u }), this.g.set(u, 0), this.f.set(u, this.distance(r.position, o.position)), this.maxFrontierSize = Math.max(this.maxFrontierSize, this.openSet.size); this.openSet.size > 0; ) {
      ...
      for (let B of this.getNeighborsInternal(C, s.get(E), o)) {
        let I = this.getNodeId(B.p), G = ((p = this.g.get(E)) != null ? p : Number.MAX_VALUE) + B.dist;
        (!this.g.has(I) || G < ((d = this.g.get(I)) != null ? d : Number.MAX_VALUE)) && (s.set(I, C), this.g.set(I, G), this.f.set(I, G + this.distance(B.p.position, o.position)), this.openSet.push({ node: B.p, id: I }));
      }
    }
...
var Ln = class {
  ...
  posChangeToLayerPos() {
    return ha(Pe((e) => ({ enter: { position: new P(e.enterTile), layer: e.enterLayer }, exit: { position: new P(e.exitTile), layer: e.exitLayer } })));
  }
  posToString(e, r) {
    return `${e.x}#${e.y}#${r}`;
  }
...
var Dn = class Dn2 {
  ...
  addCharacter(e) {
    ...
    r === void 0 ? e.setTilePosition(Lt(Y({}, e.getNextTilePos()), { layer: this.getLowestCharLayer() })) : this.getCharLayerNames().includes(r) || console.warn(`Char layer '${r}' of character '${e.getId()}' is unknown.`), this.charBlockCache.addCharacter(e);
  }
  removeCharacter(e) {
  ...
  getTileCosts(e, r) {
    ...
    for (let u of o) s = Math.max(s, this.getTileCostsForLayer(Lt(Y({}, e), { layer: u.getName() }), r));
    return s;
  }
...
var In = class {
  ...
  enqueue(e, r = {}) {
    ...
    for (let p of e) {
      ...
      if (C || (C = this.character.getNextTilePos()), Je(C)) {
        this.queue.enqueue(d);
        continue;
      }
      let E = this.distanceUtils.distance(C.position, p.position) === 1;
...
var Mn = class {
  ...
  addCharacter(e) {
    ...
    o.movementStopped().pipe(dt(this.charRemoved(s))).subscribe((C) => {
      var E;
      (E = this.movementStopped$) == null || E.next({ charId: s, direction: C });
    }), o.movementStarted().pipe(dt(this.charRemoved(s))).subscribe((C) => {
      var E;
      (E = this.movementStarted$) == null || E.next({ charId: s, direction: C });
    }), o.directionChanged().pipe(dt(this.charRemoved(s))).subscribe((C) => {
      var E;
      (E = this.directionChanged$) == null || E.next({ charId: s, direction: C });
    }), o.positionChangeStarted().pipe(dt(this.charRemoved(s))).subscribe((C) => {
      var E;
      (E = this.positionChangeStarted$) == null || E.next(Y({ charId: s }, C));
    }), o.positionChangeFinished().pipe(dt(this.charRemoved(s))).subscribe((C) => {
      var E;
      (E = this.positionChangeFinished$) == null || E.next(Y({ charId: s }, C));
  ...
  findShortestPath(e, r, o = {}) {
    ...
    let d = new Yr(this.gridTilemap).findShortestPath(W.toInternal(e), W.toInternal(r), Lt(Y({}, o), { shortestPathAlgorithm: s }));
  ...
  addQueueMovements(e, r, o) {
    ...
    })), u.enqueue(r.map((d) => Je(d) ? d : { position: new P(d.position), layer: d.charLayer }), o);
  }
  ...
  assembleMoveToConfig(e = {}) {
    let r = Lt(Y({}, e), { noPathFoundStrategy: "STOP", pathBlockedStrategy: "WAIT" });
...
var An = class extends $r {
  ...
  prune(r, o) {
    let { top: s, right: u, topRight: h, downRight: p, bottom: d } = this.normalizedPositions(r, o), T2 = this.getForced(r, o), C = Pt(r.position, o.position);
    return pr(C) ? [s, u, h, p, d, ...T2] : [u, ...T2];
  }
  jump(r, o, s, u, h) {
...
var qr = class {
  ...
  stop(e) {
    ...
    this.emitFinishedEvent === "START_MOVEMENT" ? (this.finished$.next(r), this.finished$.complete()) : this.emitFinishedEvent === "END_MOVEMENT" ? this.character.movementStopped().pipe(wt(1)).subscribe(() => {
      this.finished$.next(Lt(Y({}, r), { finishedEvent: "END_MOVEMENT" })), this.finished$.complete();
...
var Fa = UT((a5, e) => {
  (function() {
    ...
    var xp = function v(w) {
      ...
      function zp() {
        var t = this.__wrapped__.value(), i = this.__dir__, n = N(t), c = i < 0, l = n ? t.length : 0, m = id(0, l, this.__views__), g = m.start, y = m.end, b = y - g, _ = c ? y : g - 1, L = this.__iteratees__, S = L.length, O = 0, M = Ct(b, this.__takeCount__);
        if (!n || !c && l == b && M == b) return sc(t, this.__actions__);
        var R = [];
        t: for (; b-- && O < M; ) {
          _ += i;
          for (var U = -1, F = t[_]; ++U < S; ) {
            var z = L[U], q = z.iteratee, Ht = z.type, Dt = q(F);
            if (Ht == Nh) F = Dt;
            else if (!Dt) {
              if (Ht == ja) continue t;
              break t;
      ...
      function Vu(t, i) {
        ...
        for (var _ in t) (i || et.call(t, _)) && !(g && (_ == "length" || l && (_ == "offset" || _ == "parent") || m && (_ == "buffer" || _ == "byteLength" || _ == "byteOffset") || Re(_, b))) && y.push(_);
        return y;
      }
      function Nu(t) {
        var i = t.length;
      ...
      function Kt(t, i, n, c, l, m) {
        ...
        var R = _ ? b ? ks : Fs : b ? Rt : yt, U = L ? r : R(t);
      ...
      function Ts(t, i, n) {
        for (var c = n ? rs : Qi, l = t[0].length, m = t.length, g = m, y = x(m), b = 1 / 0, _ = []; g--; ) {
          var L = t[g];
          g && i && (L = at(L, Gt(i))), b = Ct(L.length, b), y[g] = !n && (i || l >= 120 && L.length >= 120) ? new ar(g && L) : r;
        }
        L = t[0];
        var S = -1, O = y[0];
        t: for (; ++S < l && _.length < b; ) {
          var M = L[S], R = i ? i(M) : M;
          if (M = n || M !== 0 ? M : 0, !(O ? oi(O, R) : c(_, R, n))) {
            for (g = m; --g; ) {
              var U = y[g];
      ...
      function Sm(t, i, n, c, l, m) {
        var g = N(t), y = N(i), b = g ? Bi : _t(t), _ = y ? Bi : _t(i);
        b = b == wr ? Oe : b, _ = _ == wr ? Oe : _;
        var L = b == Oe, S = _ == Oe, O = b == _;
        if (O && Ke(t)) {
          if (!Ke(i)) return false;
          g = true, L = false;
        }
        if (O && !L) return m || (m = new se()), g || kr(t) ? _c(t, i, n, c, l, m) : td(t, i, b, n, c, l, m);
        if (!(n & G)) {
      ...
      function Ps(t, i, n, c) {
        ...
        for (; ++l < m; ) {
          ...
          if (g && y[2]) {
            ...
            var S = new se();
            if (c) var O = c(_, L, b, t, i, S);
            if (!(O === r ? pi(L, _, G | k, c, S) : O)) return false;
          }
        }
        return true;
      }
      ...
      function Am(t, i, n, c, l, m, g) {
        var y = Hs(t, n), b = Hs(i, n), _ = g.get(b);
        if (_) {
          ds(t, n, _);
          return;
        }
        ...
        if (S) {
          ...
          L = b, O || M || R ? N(y) ? L = y : lt(y) ? L = Mt(y) : M ? (S = false, L = cc(b, true)) : R ? (S = false, L = lc(b, true)) : L = [] : vi(b) || fr(b) ? (L = y, fr(y) ? L = sl(y) : (!ut(y) || Fe(y)) && (L = Oc(b))) : S = false;
        }
        S && (g.set(b, L), l(L, b, c, m, g), g.delete(b)), ds(t, n, L);
      }
      function Ju(t, i) {
        var n = t.length;
      ...
      function Cs(t, i, n, c) {
        ...
        for (t === i && (i = Mt(i)), n && (y = at(t, Gt(n))); ++m < g; ) for (var b = 0, _ = i[m], L = n ? n(_) : _; (b = l(y, L, b, c)) > -1; ) y !== t && so.call(y, b, 1), so.call(t, b, 1);
        return t;
      }
      function ec(t, i) {
      ...
      function mi(t, i, n, c) {
        ...
        for (var l = -1, m = i.length, g = m - 1, y = t; y != null && ++l < m; ) {
          ...
          if (l != g) {
            var L = y[b];
            _ = c ? c(L, b, y) : r, _ === r && (_ = ut(L) ? L : Re(i[l + 1]) ? [] : {});
          }
          li(y, b, _), y = y[b];
        }
        return t;
      ...
      function Ss(t, i, n, c) {
        ...
        for (var g = i !== i, y = i === null, b = Ut(i), _ = i === r; l < m; ) {
          var L = co((l + m) / 2), S = n(t[L]), O = S !== r, M = S === null, R = S === S, U = Ut(S);
          if (g) var F = c || R;
          else _ ? F = R && (c || O) : y ? F = R && O && (c || !M) : b ? F = R && O && !M && (c || !U) : M || U ? F = false : F = c ? S <= i : S < i;
          F ? l = L + 1 : m = L;
        }
        return Ct(m, Uh);
      }
      ...
      function pc(t, i, n, c) {
        for (var l = -1, m = t.length, g = -1, y = n.length, b = -1, _ = i.length, L = mt(m - y, 0), S = x(L + _), O = !c; ++l < L; ) S[l] = t[l];
      ...
      function Qm(t, i, n) {
        ...
        function l() {
          ...
          var _ = m < 3 && g[0] !== b && g[m - 1] !== b ? [] : We(g, b);
          if (m -= _.length, m < n) return Pc(t, i, Po, l.placeholder, r, g, _, r, r, n - m);
      ...
      function vc(t) {
        return Ae(function(i) {
          ...
          return function() {
            ...
            for (var S = 0, O = n ? i[S].apply(this, _) : L; ++S < n; ) O = i[S].call(this, O);
            return O;
          };
        });
      }
      function Po(t, i, n, c, l, m, g, y, b, _) {
        var L = i & Se, S = i & X2, O = i & nt, M = i & (bt | fe), R = i & Vn, U = O ? r : di(t);
        function F() {
          ...
          if (c && (q = fc(q, c, l, M)), m && (q = pc(q, m, g, M)), z -= Bt, M && z < _) {
            var ht = We(q, Dt);
            return Pc(t, i, Po, F.placeholder, n, q, ht, y, b, _ - z);
          }
          var ue = S ? n : this, Ve = O ? ue[t] : t;
          return z = q.length, y ? q = gd(q, y) : R && z > 1 && q.reverse(), L && b < z && (q.length = b), this && this !== gt && this instanceof F && (Ve = U || di(Ve)), Ve.apply(ue, q);
        }
        return F;
      }
      function bc(t, i) {
      ...
      function Km(t, i, n, c) {
        var l = i & X2, m = di(t);
        function g() {
          for (var y = -1, b = arguments.length, _ = -1, L = c.length, S = x(L + b), O = this && this !== gt && this instanceof g ? m : t; ++_ < L; ) S[_] = c[_];
      ...
      function Pc(t, i, n, c, l, m, g, y, b, _) {
        var L = i & bt, S = L ? g : r, O = L ? r : g, M = L ? m : r, R = L ? r : m;
        i |= L ? pe : xr, i &= ~(L ? xr : pe), i & $t || (i &= ~(X2 | nt));
        var U = [t, i, l, M, S, R, O, y, b, _], F = n.apply(r, U);
      ...
      function Me(t, i, n, c, l, m, g, y) {
        ...
        var _ = c ? c.length : 0;
        if (_ || (i &= ~(pe | xr), c = l = r), g = g === r ? g : mt(j(g), 0), y = y === r ? y : j(y), _ -= l ? l.length : 0, i & xr) {
          var L = c, S = l;
          c = l = r;
        }
        var O = b ? r : Vs(t), M = [t, i, n, c, l, L, S, m, g, y];
        if (O && pd(M, O), t = M[0], i = M[1], n = M[2], c = M[3], l = M[4], y = M[9] = M[9] === r ? b ? 0 : t.length : mt(M[9] - _, 0), !y && i & (bt | fe) && (i &= ~(bt | fe)), !i || i == X2) var R = Ym(t, i, n);
        else i == bt || i == fe ? R = Qm(t, i, y) : (i == pe || i == (X2 | pe)) && !l.length ? R = Km(t, i, n, c) : R = Po.apply(r, M);
        var U = O ? rc : Ac;
        return Rc(U(R, M), t, i);
      }
      function wc(t, i, n, c) {
      ...
      function ed(t, i, n, c, l, m) {
        var g = n & G, y = Fs(t), b = y.length, _ = Fs(i), L = _.length;
...
`);
      ...
      function pd(t, i) {
        var n = t[1], c = i[1], l = n | c, m = l < (X2 | nt | Se), g = c == Se && n == bt || c == Se && n == Qr && t[7].length <= i[8] || c == (Se | Qr) && i[7].length <= i[8] && n == bt;
        if (!(m || g)) return t;
        c & X2 && (t[2] = i[2], l |= n & X2 ? 0 : $t);
        var y = i[3];
        if (y) {
          var b = t[3];
          t[3] = b ? fc(b, y, i[4]) : y, t[4] = b ? We(t[3], C) : i[4];
        }
        return y = i[5], y && (b = t[5], t[5] = b ? pc(b, y, i[6]) : y, t[6] = b ? We(t[5], C) : i[6]), y = i[7], y && (t[7] = y), c & Se && (t[8] = t[8] == null ? i[8] : Ct(t[8], i[8])), t[9] == null && (t[9] = i[9]), t[0] = i[0], t[1] = l, t;
      }
      function md(t) {
        var i = [];
      ...
      function Jc(t, i, n) {
        var c, l, m, g, y, b, _ = 0, L = false, S = false, O = true;
        if (typeof t != "function") throw new Yt(h);
        i = te(i) || 0, ut(n) && (L = !!n.leading, S = "maxWait" in n, m = S ? mt(te(n.maxWait) || 0, i) : m, O = "trailing" in n ? !!n.trailing : O);
        function M(ht) {
          var ue = c, Ve = l;
          return c = l = r, _ = ht, g = t.apply(Ve, ue), g;
        }
        function R(ht) {
          return _ = ht, y = yi(z, i), L ? M(ht) : g;
        }
        function U(ht) {
          var ue = ht - b, Ve = ht - _, yl = i - ue;
      ...
      function kv(t, i, n) {
        ...
        var l = Fo({}, i.imports, c.imports, wc), m = yt(l), g = cs(l, m), y, b, _ = 0, L = i.interpolate || qi, S = "__p += '", O = hs((i.escape || qi).source + "|" + L.source + "|" + (L === za ? df : qi).source + "|" + (i.evaluate || qi).source + "|$", "g"), M = "//# sourceURL=" + (et.call(i, "sourceURL") ? (i.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++zf + "]") + `
`;
        t.replace(O, function(F, z, q, Ht, Dt, Bt) {
          return q || (q = Ht), S += t.slice(_, Bt).replace(xf, hp), z && (y = true, S += `' +
__e(` + z + `) +
'`), Dt && (b = true, S += `';
` + Dt + `;
__p += '`), q && (S += `' +
      ...
      function Hv(t, i) {
        ...
        if (g && (y += b.length - y), Ys(l)) {
          if (t.slice(y).search(l)) {
            var _, L = b;
            for (l.global || (l = hs(l.source, tt($a.exec(l)) + "g")), l.lastIndex = 0; _ = l.exec(L); ) var S = _.index;
            b = b.slice(0, S === r ? y : S);
          }
      ...
      function ea(t, i, n) {
        ...
        return Xt(l, function(y) {
          ...
          t[y] = b, g && (t.prototype[y] = function() {
            ...
            if (m || _) {
              var L = t(this.__wrapped__), S = L.__actions__ = Mt(this.__actions__);
...
var $T = class {
  ...
  flattenPropertiesOnObject(a5) {
    var e, r, o, s;
    return Lt(Y(Y({}, this.flattener.memoisedFlattenedProperties.get((e = a5.class) != null ? e : a5.type)), (r = a5.properties) == null ? void 0 : r.reduce((u, h) => Y(Y({}, u), this.flattener.flattenMemberProperty(h)), {})), { name: a5.name, id: a5.id, class: (s = (o = a5.class) != null ? o : a5.type) != null ? s : null, x: a5.x, y: a5.y });
  }
  flattenPropertiesOnTile(a5) {
    var e, r, o, s;
    return Lt(Y(Y({}, this.flattener.memoisedFlattenedProperties.get((e = a5.class) != null ? e : a5.type)), (r = a5.properties) == null ? void 0 : r.reduce((u, h) => Y(Y({}, u), this.flattener.flattenMemberProperty(h)), {})), { id: a5.id, class: (s = (o = a5.class) != null ? o : a5.type) != null ? s : null });
  }
  getCustomTypesMap() {
...
var Ui = class Ui2 {
  ...
  getState() {
    return { characters: this.geHeadless.getState().characters.map((e) => Lt(Y({}, e), { offsetX: this.getOffsetX(e.id), offsetY: this.getOffsetY(e.id) })) };
  }
  setState(e) {
...
var ko2 = (a5, e, r) => (r = a5 != null ? Db2(Fb2(a5)) : {}, Vb2(e || !a5 || !a5.__esModule ? na2(r, "default", { value: a5, enumerable: true }) : r, a5));
var ga2 = ve2((Oi) => {
  var iT = function(a5, e) {
    return a5 < e ? -1 : a5 > e ? 1 : 0;
  }, oT = function(a5, e) {
...
var eh2 = ve2((UC, th) => {
  var Xl = ga2(), Yl = Ei2(), Ql = Xl.DEFAULT_COMPARATOR, cT = Xl.reverseComparator;
  function It(a5) {
    if (this.clear(), this.comparator = a5 || Ql, typeof this.comparator != "function") throw new Error("mnemonist/FibonacciHeap.constructor: given comparator should be a function.");
  }
  It.prototype.clear = function() {
...
var bh2 = ve2((qC, vh) => {
  var gh = dh2(), ST = Ei2(), OT = Ta2(), yh = va2(), ET = function(a5) {
    return Math.max(1, Math.ceil(a5 * 1.5));
  }, DT = function(a5) {
    var e = yh.getPointerArray(a5);
    return new e(a5);
...
var gr3 = class gr4 {
  ...
  getFramesForCharIndex(e, r) {
    var P2;
    let o = Math.floor(r / this.charsInRow), s = r % this.charsInRow, u = this.charsInRow * gr4.FRAMES_CHAR_ROW, h = gr4.FRAMES_CHAR_ROW * s, p = ((P2 = this.directionToFrameRow[e]) != null ? P2 : 0) + o * gr4.FRAMES_CHAR_COL, d = h + p * u;
    return { rightFoot: d, standing: d + 1, leftFoot: d + 2 };
  }
};
...
var zr2 = class extends xe2 {
  ...
  shortestPathBfs(e, r) {
    let o = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Set(), u = new je2(), h = e, p = this.distance(e.position, r.position), d = 0;
...
var On2 = class {
  ...
  isBlockingFrom(e, r, o, s, u) {
    var d;
    let h = this.fixedLayer || this.tileCollisionCache.get(o), p = (d = h == null ? void 0 : h[e]) == null ? void 0 : d[r];
    if (p !== void 0) return !u && !Sn2(p, Lh2) ? true : s === void 0 ? Sn2(p, MT2) : Sn2(p, Ea2[s]);
  }
};
function Da2(a5, e) {
  return a5 | 1 << e;
...
var Dn3 = class Dn4 {
  constructor(e, r, o, s = void 0, u = false) {
    ...
    for (let h of Ti2()) this.collidesPropNames.set(h, Dn4.ONE_WAY_COLLIDE_PROP_PREFIX + h), this.tileCostPropNames.set(h, `${Sh2}_${h}`);
...
var Mn2 = class {
  ...
  create(e, r) {
    this.isCreatedInternal = true, this.gridCharacters = /* @__PURE__ */ new Map();
    let o = this.setConfigDefaults(r);
    this.config = o, this.movementStopped$ = new Z2(), this.movementStarted$ = new Z2(), this.directionChanged$ = new Z2(), this.positionChangeStarted$ = new Z2(), this.positionChangeFinished$ = new Z2(), this.queueMovementFinished$ = new Z2(), this.charRemoved$ = new Z2(), this.charAdded$ = new Z2(), this.gridTilemap = new En2(e, this.config.collisionTilePropertyName, this.config.characterCollisionStrategy, this.recordToMap(this.config.collisionGroupRelation), this.config.cacheTileCollisions), this.addCharacters();
  }
  recordToMap(e) {
    return e ? new Map(Object.entries(e).map(([o, s]) => [o, new Set(s)])) : void 0;
  }
...
var Fa2 = UT2((a5, e) => {
  (function() {
    var r, o = "4.17.21", s = 200, u = "Unsupported core-js use. Try https://npms.io/search?q=ponyfill.", h = "Expected a function", p = "Invalid `variable` option passed into `_.template`", d = "__lodash_hash_undefined__", P2 = 500, L = "__lodash_placeholder__", E = 1, B = 2, I = 4, G = 1, k = 2, K2 = 1, nt = 2, $t = 4, bt = 8, fe = 16, pe = 32, xr = 64, Se = 128, Qr = 256, Vn = 512, Rh = 30, Fh = "...", kh = 800, Vh = 16, ja = 1, Nh = 2, Gh = 3, ir = 1 / 0, Ue = 9007199254740991, jh = 17976931348623157e292, Hi = NaN, me = 4294967295, Uh = me - 1, Hh = me >>> 1, Bh = [["ary", Se], ["bind", K2], ["bindKey", nt], ["curry", bt], ["curryRight", fe], ["flip", Vn], ["partial", pe], ["partialRight", xr], ["rearg", Qr]], wr = "[object Arguments]", Bi = "[object Array]", Wh = "[object AsyncFunction]", Kr = "[object Boolean]", Jr = "[object Date]", zh = "[object DOMException]", Wi = "[object Error]", zi = "[object Function]", Ua = "[object GeneratorFunction]", ie = "[object Map]", Zr = "[object Number]", $h = "[object Null]", Oe = "[object Object]", Ha = "[object Promise]", qh = "[object Proxy]", ti = "[object RegExp]", oe = "[object Set]", ei = "[object String]", $i = "[object Symbol]", Xh = "[object Undefined]", ri = "[object WeakMap]", Yh = "[object WeakSet]", ii = "[object ArrayBuffer]", Cr = "[object DataView]", Nn = "[object Float32Array]", Gn = "[object Float64Array]", jn = "[object Int8Array]", Un = "[object Int16Array]", Hn = "[object Int32Array]", Bn = "[object Uint8Array]", Wn = "[object Uint8ClampedArray]", zn = "[object Uint16Array]", $n = "[object Uint32Array]", Qh = /\b__p \+= '';/g, Kh = /\b(__p \+=) '' \+/g, Jh = /(__e\(.*?\)|\b__t\)) \+\n'';/g, Ba = /&(?:amp|lt|gt|quot|#39);/g, Wa = /[&<>"']/g, Zh = RegExp(Ba.source), tf = RegExp(Wa.source), ef = /<%-([\s\S]+?)%>/g, rf = /<%([\s\S]+?)%>/g, za = /<%=([\s\S]+?)%>/g, of = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, nf = /^\w*$/, sf = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, qn = /[\\^$.*+?()[\]{}|]/g, af = RegExp(qn.source), Xn = /^\s+/, uf = /\s/, cf = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, lf = /\{\n\/\* \[wrapped with (.+)\] \*/, hf = /,? & /, ff = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, pf = /[()=,{}\[\]\/\s]/, mf = /\\(\\)?/g, df = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, $a = /\w*$/, gf = /^[-+]0x[0-9a-f]+$/i, yf = /^0b[01]+$/i, vf = /^\[object .+?Constructor\]$/, bf = /^0o[0-7]+$/i, Tf = /^(?:0|[1-9]\d*)$/, Pf = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, qi = /($^)/, xf = /['\n\r\u2028\u2029\\]/g, Xi = "\\ud800-\\udfff", wf = "\\u0300-\\u036f", Cf = "\\ufe20-\\ufe2f", _f = "\\u20d0-\\u20ff", qa = wf + Cf + _f, Xa = "\\u2700-\\u27bf", Ya = "a-z\\xdf-\\xf6\\xf8-\\xff", Lf = "\\xac\\xb1\\xd7\\xf7", Sf = "\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf", Of = "\\u2000-\\u206f", Ef = " \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", Qa = "A-Z\\xc0-\\xd6\\xd8-\\xde", Ka = "\\ufe0e\\ufe0f", Ja = Lf + Sf + Of + Ef, Yn = "['\u2019]", Df = "[" + Xi + "]", Za = "[" + Ja + "]", Yi = "[" + qa + "]", tu = "\\d+", If = "[" + Xa + "]", eu = "[" + Ya + "]", ru = "[^" + Xi + Ja + tu + Xa + Ya + Qa + "]", Qn = "\\ud83c[\\udffb-\\udfff]", Mf = "(?:" + Yi + "|" + Qn + ")", iu = "[^" + Xi + "]", Kn = "(?:\\ud83c[\\udde6-\\uddff]){2}", Jn = "[\\ud800-\\udbff][\\udc00-\\udfff]", _r = "[" + Qa + "]", ou = "\\u200d", nu = "(?:" + eu + "|" + ru + ")", Af = "(?:" + _r + "|" + ru + ")", su = "(?:" + Yn + "(?:d|ll|m|re|s|t|ve))?", au = "(?:" + Yn + "(?:D|LL|M|RE|S|T|VE))?", uu = Mf + "?", cu = "[" + Ka + "]?", Rf = "(?:" + ou + "(?:" + [iu, Kn, Jn].join("|") + ")" + cu + uu + ")*", Ff = "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", kf = "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", lu = cu + uu + Rf, Vf = "(?:" + [If, Kn, Jn].join("|") + ")" + lu, Nf = "(?:" + [iu + Yi + "?", Yi, Kn, Jn, Df].join("|") + ")", Gf = RegExp(Yn, "g"), jf = RegExp(Yi, "g"), Zn = RegExp(Qn + "(?=" + Qn + ")|" + Nf + lu, "g"), Uf = RegExp([_r + "?" + eu + "+" + su + "(?=" + [Za, _r, "$"].join("|") + ")", Af + "+" + au + "(?=" + [Za, _r + nu, "$"].join("|") + ")", _r + "?" + nu + "+" + su, _r + "+" + au, kf, Ff, tu, Vf].join("|"), "g"), Hf = RegExp("[" + ou + Xi + qa + Ka + "]"), Bf = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, Wf = ["Array", "Buffer", "DataView", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Map", "Math", "Object", "Promise", "RegExp", "Set", "String", "Symbol", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap", "_", "clearTimeout", "isFinite", "parseInt", "setTimeout"], zf = -1, st = {};
    st[Nn] = st[Gn] = st[jn] = st[Un] = st[Hn] = st[Bn] = st[Wn] = st[zn] = st[$n] = true, st[wr] = st[Bi] = st[ii] = st[Kr] = st[Cr] = st[Jr] = st[Wi] = st[zi] = st[ie] = st[Zr] = st[Oe] = st[ti] = st[oe] = st[ei] = st[ri] = false;
    var ot = {};
    ot[wr] = ot[Bi] = ot[ii] = ot[Cr] = ot[Kr] = ot[Jr] = ot[Nn] = ot[Gn] = ot[jn] = ot[Un] = ot[Hn] = ot[ie] = ot[Zr] = ot[Oe] = ot[ti] = ot[oe] = ot[ei] = ot[$i] = ot[Bn] = ot[Wn] = ot[zn] = ot[$n] = true, ot[Wi] = ot[zi] = ot[ri] = false;
    var $f = { \u00C0: "A", \u00C1: "A", \u00C2: "A", \u00C3: "A", \u00C4: "A", \u00C5: "A", \u00E0: "a", \u00E1: "a", \u00E2: "a", \u00E3: "a", \u00E4: "a", \u00E5: "a", \u00C7: "C", \u00E7: "c", \u00D0: "D", \u00F0: "d", \u00C8: "E", \u00C9: "E", \u00CA: "E", \u00CB: "E", \u00E8: "e", \u00E9: "e", \u00EA: "e", \u00EB: "e", \u00CC: "I", \u00CD: "I", \u00CE: "I", \u00CF: "I", \u00EC: "i", \u00ED: "i", \u00EE: "i", \u00EF: "i", \u00D1: "N", \u00F1: "n", \u00D2: "O", \u00D3: "O", \u00D4: "O", \u00D5: "O", \u00D6: "O", \u00D8: "O", \u00F2: "o", \u00F3: "o", \u00F4: "o", \u00F5: "o", \u00F6: "o", \u00F8: "o", \u00D9: "U", \u00DA: "U", \u00DB: "U", \u00DC: "U", \u00F9: "u", \u00FA: "u", \u00FB: "u", \u00FC: "u", \u00DD: "Y", \u00FD: "y", \u00FF: "y", \u00C6: "Ae", \u00E6: "ae", \u00DE: "Th", \u00FE: "th", \u00DF: "ss", \u0100: "A", \u0102: "A", \u0104: "A", \u0101: "a", \u0103: "a", \u0105: "a", \u0106: "C", \u0108: "C", \u010A: "C", \u010C: "C", \u0107: "c", \u0109: "c", \u010B: "c", \u010D: "c", \u010E: "D", \u0110: "D", \u010F: "d", \u0111: "d", \u0112: "E", \u0114: "E", \u0116: "E", \u0118: "E", \u011A: "E", \u0113: "e", \u0115: "e", \u0117: "e", \u0119: "e", \u011B: "e", \u011C: "G", \u011E: "G", \u0120: "G", \u0122: "G", \u011D: "g", \u011F: "g", \u0121: "g", \u0123: "g", \u0124: "H", \u0126: "H", \u0125: "h", \u0127: "h", \u0128: "I", \u012A: "I", \u012C: "I", \u012E: "I", \u0130: "I", \u0129: "i", \u012B: "i", \u012D: "i", \u012F: "i", \u0131: "i", \u0134: "J", \u0135: "j", \u0136: "K", \u0137: "k", \u0138: "k", \u0139: "L", \u013B: "L", \u013D: "L", \u013F: "L", \u0141: "L", \u013A: "l", \u013C: "l", \u013E: "l", \u0140: "l", \u0142: "l", \u0143: "N", \u0145: "N", \u0147: "N", \u014A: "N", \u0144: "n", \u0146: "n", \u0148: "n", \u014B: "n", \u014C: "O", \u014E: "O", \u0150: "O", \u014D: "o", \u014F: "o", \u0151: "o", \u0154: "R", \u0156: "R", \u0158: "R", \u0155: "r", \u0157: "r", \u0159: "r", \u015A: "S", \u015C: "S", \u015E: "S", \u0160: "S", \u015B: "s", \u015D: "s", \u015F: "s", \u0161: "s", \u0162: "T", \u0164: "T", \u0166: "T", \u0163: "t", \u0165: "t", \u0167: "t", \u0168: "U", \u016A: "U", \u016C: "U", \u016E: "U", \u0170: "U", \u0172: "U", \u0169: "u", \u016B: "u", \u016D: "u", \u016F: "u", \u0171: "u", \u0173: "u", \u0174: "W", \u0175: "w", \u0176: "Y", \u0177: "y", \u0178: "Y", \u0179: "Z", \u017B: "Z", \u017D: "Z", \u017A: "z", \u017C: "z", \u017E: "z", \u0132: "IJ", \u0133: "ij", \u0152: "Oe", \u0153: "oe", \u0149: "'n", \u017F: "s" }, qf = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" }, Xf = { "&amp;": "&", "&lt;": "<", "&gt;": ">", "&quot;": '"', "&#39;": "'" }, Yf = { "\\": "\\", "'": "'", "\n": "n", "\r": "r", "\u2028": "u2028", "\u2029": "u2029" }, Qf = parseFloat, Kf = parseInt, hu = typeof global == "object" && global && global.Object === Object && global, Jf = typeof self == "object" && self && self.Object === Object && self, gt = hu || Jf || Function("return this")(), ts = typeof a5 == "object" && a5 && !a5.nodeType && a5, or = ts && typeof e == "object" && e && !e.nodeType && e, fu = or && or.exports === ts, es = fu && hu.process, qt = (function() {
    ...
    var xp = function v(w) {
      ...
      function Po(t, i, n, c, l, m, g, y, b, C) {
        ...
        function F() {
          ...
          var ue = S ? n : this, Ve = O ? ue[t] : t;
          return z = q.length, y ? q = gd(q, y) : R && z > 1 && q.reverse(), _ && b < z && (q.length = b), this && this !== gt && this instanceof F && (Ve = U || di(Ve)), Ve.apply(ue, q);
        }
        return F;
      }
      function bc(t, i) {
