...
describe("TiledLayer", () => {
  ...
  it("gets name", () => {
    const tiledLayerUndefinedName = new TiledLayer(tilesets, {...rawLayer, name: undefined});
  ...
  it("gets property", () => {
    const tiledLayerEmptyProps = new TiledLayer(tilesets, {...rawLayer, properties: []});
    const tiledLayerNoProps = new TiledLayer(tilesets, {...rawLayer, properties: undefined});
    const tiledLayer = new TiledLayer(tilesets, rawLayer);
  ...
  it("detects char layers", () => {
    const charLayer = new TiledLayer(tilesets, {...rawLayer, properties: [{
      name: 'ge_charLayer', value: 'true',
    }]});
    const tiledLayer = new TiledLayer(tilesets, rawLayer);
