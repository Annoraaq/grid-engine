...
`;else if(zd.test(G))throw new B(c);A=(T?A.replace(Pd,""):A).replace(Td,"$1").replace(xd,"$1;"),A="function("+(G||"obj")+`) {
`+(G?"":`obj || (obj = {});
`)+"var __t, __p = ''"+(w?", __e = _.escape":"")+(T?`, __j = Array.prototype.join;
function print() { __p += __j.call(arguments, '') }
`:`;
`)+A+`return __p
}`;var $=Bc(function(){return rt(g,F+"return "+A).apply(e,v)});if($.source=A,eu($))throw $;return $}function aP(n){return ot(n).toLowerCase()}function uP(n){return ot(n).toUpperCase()}function hP(n,o,u){if(n=ot(n),n&&(u||o===e))return Zh(n);if(!n||!(o=ge(o)))return n;var l=Ge(n),p=Ge(o),g=tl(l,p),v=el(l,p)+1;return Nr(l,g,v).join("")}function lP(n,o,u){if(n=ot(n),n&&(u||o===e))return n.slice(0,il(n)+1);if(!n||!(o=ge(o)))return n;var l=Ge(n),p=el(l,Ge(o))+1;return Nr(l,0,p).join("")}function cP(n,o,u){if(n=ot(n),n&&(u||o===e))return n.replace(ea,"");if(!n||!(o=ge(o)))return n;var l=Ge(n),p=tl(l,Ge(o));return Nr(l,p).join("")}function fP(n,o){var u=od,l=sd;if(gt(o)){var p="separator"in o?o.separator:p;u="length"in o?q(o.length):u,l="omission"in o?ge(o.omission):l}n=ot(n);var g=n.length;if(wi(n)){var v=Ge(n);g=v.length}if(u>=g)return n;var w=u-Pi(l);if(w<1)return l;var T=v?Nr(v,0,w).join(""):n.slice(0,w);if(p===e)return T+l;if(v&&(w+=T.length-w),ru(p)){if(n.slice(w).search(p)){var E,O=T;for(p.global||(p=va(p.source,ot(Ph.exec(p))+"g")),p.lastIndex=0;E=p.exec(O);)var A=E.index;T=T.slice(0,A===e?w:A)}}else if(n.indexOf(ge(p),w)!=w){var D=T.lastIndexOf(p);D>-1&&(T=T.slice(0,D))}return T+l}function pP(n){return n=ot(n),n&&Cd.test(n)?n.replace(vh,Ug):n}var mP=Li(function(n,o,u){return n+(u?" ":"")+o.toUpperCase()}),ou=Wl("toUpperCase");function Hc(n,o,u){return n=ot(n),o=u?e:o,o===e?zg(n)?Wg(n):Eg(n):n.match(o)||[]}var Bc=Y(function(n,o){try{return me(n,e,o)}catch(u){return eu(u)?u:new B(u)}}),dP=Pr(function(n,o){return Ee(o,function(u){u=tr(u),br(n,u,Za(n[u],n))}),n});function gP(n){var o=n==null?0:n.length,u=N();return n=o?pt(n,function(l){if(typeof l[1]!="function")throw new Oe(h);return[u(l[0]),l[1]]}):[],Y(function(l){for(var p=-1;++p<o;){var g=n[p];if(me(g[0],this,l))return me(g[1],this,l)}})}function yP(n){return Uy(Ie(n,b))}function su(n){return function(){return n}}function vP(n,o){return n==null||n!==n?o:n}var bP=$l(),wP=$l(!0);function he(n){return n}function au(n){return xl(typeof n=="function"?n:Ie(n,b))}function PP(n){return Sl(Ie(n,b))}function TP(n,o){return _l(n,Ie(o,b))}var xP=Y(function(n,o){return function(u){return mn(u,n,o)}}),CP=Y(function(n,o){return function(u){return mn(n,u,o)}});function uu(n,o,u){var l=zt(o),p=yo(o,l);u==null&&!(gt(o)&&(p.length||!l.length))&&(u=o,o=n,n=this,p=yo(o,zt(o)));var g=!(gt(u)&&"chain"in u)||!!u.chain,v=xr(n);return Ee(p,function(w){var T=o[w];n[w]=T,v&&(n.prototype[w]=function(){var E=this.__chain__;if(g||E){var O=n(this.__wrapped__),A=O.__actions__=se(this.__actions__);return A.push({func:T,args:arguments,thisArg:n}),O.__chain__=E,O}return T.apply(n,Mr([this.value()],arguments))})}),n}function SP(){return Ft._===this&&(Ft._=Kg),this}function hu(){}function _P(n){return n=q(n),Y(function(o){return Ll(o,n)})}var LP=ja(pt),EP=ja(Yh),OP=ja(ca);function Wc(n){return $a(n)?fa(tr(n)):ov(n)}function AP(n){return function(o){return n==null?e:ti(n,o)}}var IP=Ql(),MP=Ql(!0);function lu(){return[]}function cu(){return!1}function DP(){return{}}function kP(){return""}function RP(){return!0}function FP(n,o){if(n=q(n),n<1||n>Ar)return[];var u=Ke,l=Yt(n,Ke);o=N(o),n-=Ke;for(var p=da(l,o);++u<n;)o(u);return p}function zP(n){return W(n)?pt(n,tr):ye(n)?[n]:se(cc(ot(n)))}function VP(n){var o=++Qg;return ot(n)+o}var NP=xo(function(n,o){return n+o},0),jP=Ga("ceil"),GP=xo(function(n,o){return n/o},1),UP=Ga("floor");function HP(n){return n&&n.length?go(n,he,_a):e}function BP(n,o){return n&&n.length?go(n,N(o,2),_a):e}function WP(n){return Kh(n,he)}function qP(n,o){return Kh(n,N(o,2))}function $P(n){return n&&n.length?go(n,he,Aa):e}function YP(n,o){return n&&n.length?go(n,N(o,2),Aa):e}var QP=xo(function(n,o){return n*o},1),XP=Ga("round"),KP=xo(function(n,o){return n-o},0);function JP(n){return n&&n.length?ma(n,he):0}function ZP(n,o){return n&&n.length?ma(n,N(o,2)):0}return d.after=P0,d.ary=Tc,d.assign=uw,d.assignIn=Fc,d.assignInWith=Fo,d.assignWith=hw,d.at=lw,d.before=xc,d.bind=Za,d.bindAll=dP,d.bindKey=Cc,d.castArray=D0,d.chain=bc,d.chunk=Uv,d.compact=Hv,d.concat=Bv,d.cond=gP,d.conforms=yP,d.constant=su,d.countBy=Jb,d.create=cw,d.curry=Sc,d.curryRight=_c,d.debounce=Lc,d.defaults=fw,d.defaultsDeep=pw,d.defer=T0,d.delay=x0,d.difference=Wv,d.differenceBy=qv,d.differenceWith=$v,d.drop=Yv,d.dropRight=Qv,d.dropRightWhile=Xv,d.dropWhile=Kv,d.fill=Jv,d.filter=t0,d.flatMap=i0,d.flatMapDeep=n0,d.flatMapDepth=o0,d.flatten=dc,d.flattenDeep=Zv,d.flattenDepth=tb,d.flip=C0,d.flow=bP,d.flowRight=wP,d.fromPairs=eb,d.functions=ww,d.functionsIn=Pw,d.groupBy=s0,d.initial=ib,d.intersection=nb,d.intersectionBy=ob,d.intersectionWith=sb,d.invert=xw,d.invertBy=Cw,d.invokeMap=u0,d.iteratee=au,d.keyBy=h0,d.keys=zt,d.keysIn=ue,d.map=Ao,d.mapKeys=_w,d.mapValues=Lw,d.matches=PP,d.matchesProperty=TP,d.memoize=Mo,d.merge=Ew,d.mergeWith=zc,d.method=xP,d.methodOf=CP,d.mixin=uu,d.negate=Do,d.nthArg=_P,d.omit=Ow,d.omitBy=Aw,d.once=S0,d.orderBy=l0,d.over=LP,d.overArgs=_0,d.overEvery=EP,d.overSome=OP,d.partial=tu,d.partialRight=Ec,d.partition=c0,d.pick=Iw,d.pickBy=Vc,d.property=Wc,d.propertyOf=AP,d.pull=lb,d.pullAll=yc,d.pullAllBy=cb,d.pullAllWith=fb,d.pullAt=pb,d.range=IP,d.rangeRight=MP,d.rearg=L0,d.reject=m0,d.remove=mb,d.rest=E0,d.reverse=Ka,d.sampleSize=g0,d.set=Dw,d.setWith=kw,d.shuffle=y0,d.slice=db,d.sortBy=w0,d.sortedUniq=Tb,d.sortedUniqBy=xb,d.split=iP,d.spread=O0,d.tail=Cb,d.take=Sb,d.takeRight=_b,d.takeRightWhile=Lb,d.takeWhile=Eb,d.tap=Hb,d.throttle=A0,d.thru=Oo,d.toArray=Dc,d.toPairs=Nc,d.toPairsIn=jc,d.toPath=zP,d.toPlainObject=Rc,d.transform=Rw,d.unary=I0,d.union=Ob,d.unionBy=Ab,d.unionWith=Ib,d.uniq=Mb,d.uniqBy=Db,d.uniqWith=kb,d.unset=Fw,d.unzip=Ja,d.unzipWith=vc,d.update=zw,d.updateWith=Vw,d.values=Ai,d.valuesIn=Nw,d.without=Rb,d.words=Hc,d.wrap=M0,d.xor=Fb,d.xorBy=zb,d.xorWith=Vb,d.zip=Nb,d.zipObject=jb,d.zipObjectDeep=Gb,d.zipWith=Ub,d.entries=Nc,d.entriesIn=jc,d.extend=Fc,d.extendWith=Fo,uu(d,d),d.add=NP,d.attempt=Bc,d.camelCase=Hw,d.capitalize=Gc,d.ceil=jP,d.clamp=jw,d.clone=k0,d.cloneDeep=F0,d.cloneDeepWith=z0,d.cloneWith=R0,d.conformsTo=V0,d.deburr=Uc,d.defaultTo=vP,d.divide=GP,d.endsWith=Bw,d.eq=He,d.escape=Ww,d.escapeRegExp=qw,d.every=Zb,d.find=e0,d.findIndex=pc,d.findKey=mw,d.findLast=r0,d.findLastIndex=mc,d.findLastKey=dw,d.floor=UP,d.forEach=wc,d.forEachRight=Pc,d.forIn=gw,d.forInRight=yw,d.forOwn=vw,d.forOwnRight=bw,d.get=iu,d.gt=N0,d.gte=j0,d.has=Tw,d.hasIn=nu,d.head=gc,d.identity=he,d.includes=a0,d.indexOf=rb,d.inRange=Gw,d.invoke=Sw,d.isArguments=ii,d.isArray=W,d.isArrayBuffer=G0,d.isArrayLike=ae,d.isArrayLikeObject=Pt,d.isBoolean=U0,d.isBuffer=jr,d.isDate=H0,d.isElement=B0,d.isEmpty=W0,d.isEqual=q0,d.isEqualWith=$0,d.isError=eu,d.isFinite=Y0,d.isFunction=xr,d.isInteger=Oc,d.isLength=ko,d.isMap=Ac,d.isMatch=Q0,d.isMatchWith=X0,d.isNaN=K0,d.isNative=J0,d.isNil=tw,d.isNull=Z0,d.isNumber=Ic,d.isObject=gt,d.isObjectLike=bt,d.isPlainObject=wn,d.isRegExp=ru,d.isSafeInteger=ew,d.isSet=Mc,d.isString=Ro,d.isSymbol=ye,d.isTypedArray=Oi,d.isUndefined=rw,d.isWeakMap=iw,d.isWeakSet=nw,d.join=ab,d.kebabCase=$w,d.last=De,d.lastIndexOf=ub,d.lowerCase=Yw,d.lowerFirst=Qw,d.lt=ow,d.lte=sw,d.max=HP,d.maxBy=BP,d.mean=WP,d.meanBy=qP,d.min=$P,d.minBy=YP,d.stubArray=lu,d.stubFalse=cu,d.stubObject=DP,d.stubString=kP,d.stubTrue=RP,d.multiply=QP,d.nth=hb,d.noConflict=SP,d.noop=hu,d.now=Io,d.pad=Xw,d.padEnd=Kw,d.padStart=Jw,d.parseInt=Zw,d.random=Uw,d.reduce=f0,d.reduceRight=p0,d.repeat=tP,d.replace=eP,d.result=Mw,d.round=XP,d.runInContext=P,d.sample=d0,d.size=v0,d.snakeCase=rP,d.some=b0,d.sortedIndex=gb,d.sortedIndexBy=yb,d.sortedIndexOf=vb,d.sortedLastIndex=bb,d.sortedLastIndexBy=wb,d.sortedLastIndexOf=Pb,d.startCase=nP,d.startsWith=oP,d.subtract=KP,d.sum=JP,d.sumBy=ZP,d.template=sP,d.times=FP,d.toFinite=Cr,d.toInteger=q,d.toLength=kc,d.toLower=aP,d.toNumber=ke,d.toSafeInteger=aw,d.toString=ot,d.toUpper=uP,d.trim=hP,d.trimEnd=lP,d.trimStart=cP,d.truncate=fP,d.unescape=pP,d.uniqueId=VP,d.upperCase=mP,d.upperFirst=ou,d.each=wc,d.eachRight=Pc,d.first=gc,uu(d,function(){var n={};return Je(d,function(o,u){st.call(d.prototype,u)||(n[u]=o)}),n}(),{chain:!1}),d.VERSION=i,Ee(["bind","bindKey","curry","curryRight","partial","partialRight"],function(n){d[n].placeholder=d}),Ee(["drop","take"],function(n,o){X.prototype[n]=function(u){u=u===e?1:It(q(u),0);var l=this.__filtered__&&!o?new X(this):this.clone();return l.__filtered__?l.__takeCount__=Yt(u,l.__takeCount__):l.__views__.push({size:Yt(u,Ke),type:n+(l.__dir__<0?"Right":"")}),l},X.prototype[n+"Right"]=function(u){return this.reverse()[n](u).reverse()}}),Ee(["filter","map","takeWhile"],function(n,o){var u=o+1,l=u==dh||u==ld;X.prototype[n]=function(p){var g=this.clone();return g.__iteratees__.push({iteratee:N(p,3),type:u}),g.__filtered__=g.__filtered__||l,g}}),Ee(["head","last"],function(n,o){var u="take"+(o?"Right":"");X.prototype[n]=function(){return this[u](1).value()[0]}}),Ee(["initial","tail"],function(n,o){var u="drop"+(o?"":"Right");X.prototype[n]=function(){return this.__filtered__?new X(this):this[u](1)}}),X.prototype.compact=function(){return this.filter(he)},X.prototype.find=function(n){return this.filter(n).head()},X.prototype.findLast=function(n){return this.reverse().find(n)},X.prototype.invokeMap=Y(function(n,o){return typeof n=="function"?new X(this):this.map(function(u){return mn(u,n,o)})}),X.prototype.reject=function(n){return this.filter(Do(N(n)))},X.prototype.slice=function(n,o){n=q(n);var u=this;return u.__filtered__&&(n>0||o<0)?new X(u):(n<0?u=u.takeRight(-n):n&&(u=u.drop(n)),o!==e&&(o=q(o),u=o<0?u.dropRight(-o):u.take(o-n)),u)},X.prototype.takeRightWhile=function(n){return this.reverse().takeWhile(n).reverse()},X.prototype.toArray=function(){return this.take(Ke)},Je(X.prototype,function(n,o){var u=/^(?:filter|find|map|reject)|While$/.test(o),l=/^(?:head|last)$/.test(o),p=d[l?"take"+(o=="last"?"Right":""):o],g=l||/^find/.test(o);p&&(d.prototype[o]=function(){var v=this.__wrapped__,w=l?[1]:arguments,T=v instanceof X,E=w[0],O=T||W(v),A=function(Q){var K=p.apply(d,Mr([Q],w));return l&&D?K[0]:K};O&&u&&typeof E=="function"&&E.length!=1&&(T=O=!1);var D=this.__chain__,F=!!this.__actions__.length,G=g&&!D,$=T&&!F;if(!g&&O){v=$?v:new X(this);var U=n.apply(v,w);return U.__actions__.push({func:Oo,args:[A],thisArg:e}),new Ae(U,D)}return G&&$?n.apply(this,w):(U=this.thru(A),G?l?U.value()[0]:U.value():U)})}),Ee(["pop","push","shift","sort","splice","unshift"],function(n){var o=to[n],u=/^(?:push|sort|unshift)$/.test(n)?"tap":"thru",l=/^(?:pop|shift)$/.test(n);d.prototype[n]=function(){var p=arguments;if(l&&!this.__chain__){var g=this.value();return o.apply(W(g)?g:[],p)}return this[u](function(v){return o.apply(W(v)?v:[],p)})}}),Je(X.prototype,function(n,o){var u=d[o];if(u){var l=u.name+"";st.call(Ci,l)||(Ci[l]=[]),Ci[l].push({name:o,func:u})}}),Ci[To(e,j).name]=[{name:"wrapper",func:e}],X.prototype.clone=py,X.prototype.reverse=my,X.prototype.value=dy,d.prototype.at=Bb,d.prototype.chain=Wb,d.prototype.commit=qb,d.prototype.next=$b,d.prototype.plant=Qb,d.prototype.reverse=Xb,d.prototype.toJSON=d.prototype.valueOf=d.prototype.value=Kb,d.prototype.first=d.prototype.head,an&&(d.prototype[an]=Yb),d},kr=qg();typeof define=="function"&&typeof define.amd=="object"&&define.amd?(Ft._=kr,define(function(){return kr})):Qr?((Qr.exports=kr)._=kr,aa._=kr):Ft._=kr}).call(r)}),rd=class extends Set{constructor(r,t=!1){super(r),this.valuesAsFlags=t}};function Vn(r){if(r instanceof Map)return Object.fromEntries([...r.entries()].map(([t,e])=>[t,Vn(e)]));if(r instanceof Set)return Array.from(r.values()).map(Vn);if(r instanceof rd)return{values:[...r.values()],valuesAsFlags:r.valuesAsFlags};if(typeof r=="object"){let t={};return Object.entries(r).forEach(([e,i])=>{t[e]=Vn(i)}),t}else return r}var cM=hh(lh(),1);var V1=hh(lh(),1);function mi(r,t){if(typeof r!="object")throw new Error(`Cannot merge into non-object objectToMergeWith. Received: ${JSON.stringify(r)}`);if(typeof t!="object")throw new Error(`Cannot merge using non-object objectToMergeWith. Received: ${JSON.stringify(t)}`);let e=(0,V1.cloneDeep)(r);for(let[i,s]of Object.entries(t))typeof s!="object"||s instanceof Set||e[i]===void 0?e[i]=s:e[i]=mi(e[i],s);return e}function id(r,t){if(!(r===void 0||typeof r!="object"))for(let e of Object.keys(r)){if(e===t)return r[e];let i=r[e];if(typeof i=="object"){let s=id(i,t);if(s!==void 0)return s}}}var uh="@composite:",N1="@inherit:",j1=class{constructor(r,t,e){this.tiledClassToMembersMap=r,this.enumNameToValuesMap=t,this.parserOptions=e,this.memoiser=new Map}flattenMembers(r,t){return this.memoiser.has(r)?{[r]:this.memoiser.get(r)}:(this.memoiser.set(r,t.reduce((e,i)=>it(it({},e),this.flattenMemberProperty(i)),{})),{[r]:this.memoiser.get(r)})}flattenMemberProperty(r){var e;let t=(e=r.propertyType)!=null?e:r.propertytype;if(r.type==="class"){if(!this.memoiser.has(t)){let a=this.tiledClassToMembersMap.get(t).reduce((h,c)=>mi(this.flattenMemberProperty(c),h),{});this.memoiser.set(t,a)}let i=this.memoiser.get(t),s=mi(i,this.flattenValue(r.value,i));return this.checkIfShouldFlatten(r.name)?s:{[r.name.replace(uh,"")]:s}}else return this.enumNameToValuesMap.has(t)?this.enumNameToValuesMap.get(t).valuesAsFlags?{[r.name]:new Set(r.value.split(",").filter(i=>i!==""))}:{[r.name]:r.value}:{[r.name]:r.value}}get memoisedFlattenedProperties(){return this.memoiser}flattenValue(r,t){return Object.entries(r).reduce((e,[i,s])=>{if(typeof s!="object")return id(t,i)instanceof Set?mi({[i]:new Set(s.split(",").filter(a=>a!==""))},e):mi({[i]:s},e);if(this.checkIfShouldFlatten(i))return mi(this.flattenValue(s,t),e);{let a=i.replace(uh,"");return mi({[a]:this.flattenValue(s,t)},e)}},{})}checkIfShouldFlatten(r){var t;return((t=this.parserOptions)==null?void 0:t.defaultComposite)===!0?r.startsWith(N1):!r.startsWith(uh)}},td=hh(lh(),1),G1=class{constructor(r){this.flattener=r}flattenPropertiesOnObject(r){var t,e,i,s;return we(it(it({},this.flattener.memoisedFlattenedProperties.get((t=r.class)!=null?t:r.type)),(e=r.properties)==null?void 0:e.reduce((a,h)=>it(it({},a),this.flattener.flattenMemberProperty(h)),{})),{name:r.name,id:r.id,class:(s=(i=r.class)!=null?i:r.type)!=null?s:null,x:r.x,y:r.y})}flattenPropertiesOnTile(r){var t,e,i,s;return we(it(it({},this.flattener.memoisedFlattenedProperties.get((t=r.class)!=null?t:r.type)),(e=r.properties)==null?void 0:e.reduce((a,h)=>it(it({},a),this.flattener.flattenMemberProperty(h)),{})),{id:r.id,class:(s=(i=r.class)!=null?i:r.type)!=null?s:null})}getCustomTypesMap(){return new Map([...this.flattener.memoisedFlattenedProperties.entries()].map(([r,t])=>[r,(0,td.cloneDeep)(t)]))}getEnumsMap(){return new Map([...this.flattener.enumNameToValuesMap.entries()].map(([r,t])=>[r,(0,td.cloneDeep)(t)]))}toJSON(){return JSON.stringify({customTypes:Vn(this.getCustomTypesMap()),enums:Vn(this.getEnumsMap())},null,4)}};function U1(r,t){let e=new Map(r.propertyTypes.filter(a=>a.type==="enum").map(a=>[a.name,new rd(a.values,a.valuesAsFlags)])),i=new Map(r.propertyTypes.filter(a=>a.type==="class").map(a=>[a.name,a.members])),s=new j1(i,e,t);return i.forEach((a,h)=>{s.flattenMembers(h,a)}),new G1(s)}var nd={parse:U1};var di=class{constructor(t,e){this.phaserTile=t;this.tiledProject=e}getProperty(t){var s,a;let e={};if(this.tiledProject){let h=nd.parse(this.tiledProject),c=this.getType();if(c){let f=(s=h.getCustomTypesMap())==null?void 0:s.get(c);if(f)for(let[m,y]of Object.entries(f))e[m]=y}}return(a=this.phaserTile.properties[t])!=null?a:e[t]}hasProperty(t){return this.getProperty(t)!=null}getType(){var t,e;return(e=(t=this.phaserTile.tileset)==null?void 0:t.tileData[this.phaserTile.index-1])==null?void 0:e.type}};var Nn=class{constructor(t,e){this.phaserTilemapLayer=t;this.tiledProject=e}getName(){return this.phaserTilemapLayer.layer.name}getProperty(t){let e=this.phaserTilemapLayer.layer.properties,i=e==null?void 0:e.find(s=>s.name==t);return i==null?void 0:i.value}hasProperty(t){return this.getProperty(t)!=null}isCharLayer(){return this.hasProperty(Qi)}getData(){return this.phaserTilemapLayer.layer.data.map(t=>t.map(e=>new di(e,this.tiledProject)))}};var Us=class{constructor(t,e){this.phaserTilemap=t;this.tiledProject=e;for(let i of this.phaserTilemap.layers)if(i.tilemapLayer==null)throw new Error(`Error initializing tilemap. Layer '${i.name}' has no 'tilemapLayer'. This can happen if you call 'createLayer' with the wrong layer ID.`)}getTileWidth(){return this.phaserTilemap.tileWidth}getTileHeight(){return this.phaserTilemap.tileHeight}getWidth(){return this.phaserTilemap.width}getHeight(){return this.phaserTilemap.height}getOrientation(){return this.phaserTilemap.orientation==Phaser.Tilemaps.Orientation.ISOMETRIC.toString()?"isometric":"orthogonal"}getLayers(){return this.phaserTilemap.layers.map(t=>new Nn(t.tilemapLayer,this.tiledProject))}hasTileAt(t,e,i){return!!this.phaserTilemap.hasTileAt(t,e,i)}getTileAt(t,e,i){let s=this.phaserTilemap.getTileAt(t,e,!1,i);if(s)return new di(s,this.tiledProject)}};var ch=class{constructor(t,e="orthogonal",i="ge_collide"){this.map=t;this.orientation=e;this.layerMap=new Map;this.layers=[];let s=-1,a=-1;Object.entries(t).map(([h,c])=>{var _;let f=(_=c.data[0])==null?void 0:_.length,m=c.data.length;if(s!==-1&&s!==f||a!==-1&&a!==m)throw new Error("All tilemap layers must have the same dimensions.");s=f,a=m;let y=[];for(let C=0;C<c.data.length;C++){let I=[];for(let M=0;M<c.data[C].length;M++){let R=new ph(c.data[C][M]===1,i);I.push(R)}y.push(I)}let b=new fh(h,y,c.isCharLayer);this.layers.push(b),this.layerMap.set(h,b)})}getWidth(){var t,e;return((e=(t=Object.values(this.map)[0])==null?void 0:t.data[0])==null?void 0:e.length)||0}getHeight(){var t;return((t=Object.values(this.map)[0])==null?void 0:t.data.length)||0}getOrientation(){return this.orientation}getLayers(){return this.layers}hasTileAt(t,e,i){return!i||!this.layerMap.get(i)?!1:t>=0&&t<this.getWidth()&&e>=0&&e<this.getHeight()}getTileAt(t,e,i){if(!i)return;let s=this.layerMap.get(i);if(s)return s.getData()[e][t]}},fh=class{constructor(t,e,i=!1){this.name=t;this.tiles=e;this.isCharLayerInternal=i}getName(){return this.name}getProperty(t){if(t==="ge_charLayer"&&this.isCharLayerInternal)return this.name}hasProperty(t){return t==="ge_charLayer"&&this.isCharLayerInternal}getData(){return this.tiles}isCharLayer(){return this.isCharLayerInternal}},ph=class{constructor(t,e){this.isBlocking=t;this.collisionPropertyName=e}getProperty(t){return t===this.collisionPropertyName?this.isBlocking:!1}hasProperty(t){return t===this.collisionPropertyName}};var jn=class{constructor(t,e){this.props={};var a;let i=t.find(h=>{var m;if(!h.tiles)return!1;let c=(m=h.firstgid)!=null?m:0;return!!h.tiles.find(y=>y.id+c===e)});if(!i)return;let s=(a=i.tiles)==null?void 0:a.find(h=>{var c;return h.id+((c=i.firstgid)!=null?c:0)===e});if(s!=null&&s.properties)for(let h of s.properties)h.name&&(this.props[h.name]=h.value)}getProperty(t){return this.props[t]}hasProperty(t){return this.props[t]!==void 0}};var Gn=class{constructor(t,e){this.layer=e;this.data=[];if(this.data=[],this.layer.data)for(let i=0;i<(this.layer.height||0);i++){let s=[];for(let a=0;a<(this.layer.width||0);a++){let h=this.layer.data[i*(this.layer.width||0)+a];h!==void 0?s.push(new jn(t,h)):s.push(void 0)}this.data.push(s)}}getName(){return this.layer.name}getProperty(t){var e,i;return(i=(e=this.layer.properties)==null?void 0:e.find(s=>s.name===t))==null?void 0:i.value}hasProperty(t){return this.getProperty(t)!==void 0}getData(){return this.data}isCharLayer(){return this.hasProperty("ge_charLayer")}};var mh=class{constructor(t){this.rawTilemap=t;this.layers=[];var e;this.layers=(e=this.rawTilemap.layers)==null?void 0:e.map(i=>new Gn(this.rawTilemap.tilesets,i))}hasTileAt(t,e,i){if(t<0||t>=this.rawTilemap.width||e<0||e>=this.rawTilemap.height||!this.rawTilemap.layers)return!1;let s=this.rawTilemap.layers.find(h=>h.name===i);if(!s)return!1;let a=e*this.rawTilemap.width+t;return s.data[a]>0}getTileAt(t,e,i){if(t<0||t>=this.rawTilemap.width||e<0||e>=this.rawTilemap.height||!this.rawTilemap.layers)return;let s=this.layers.find(a=>a.getName()===i);if(s)return s.getData()[e][t]}getOrientation(){return this.rawTilemap.orientation}getLayers(){return this.layers}getWidth(){return this.rawTilemap.width}getHeight(){return this.rawTilemap.height}};var Un=class Un{constructor(t){this.scene=t;this.geHeadless=new Ns(!1);this.isCreatedInternal=!1;Un.welcomeMessagePrinted||(console.log(`Using GridEngine Phaser Plugin v${Ms}`),Un.welcomeMessagePrinted=!0),this.scene.sys.events.once("boot",this.boot,this)}boot(){this.scene.sys.events.on("update",this.update,this)}getCharLayer(t){return this.geHeadless.getCharLayer(t)}getTransition(t,e){return this.geHeadless.getTransition(t,e)}setTransition(t,e,i){this.geHeadless.setTransition(t,e,i)}create(t,e){this.geHeadless.create(new Us(t,e.tiledProject),e),this.isCreatedInternal=!0,this.gridCharacters=new Map;let i=this.setConfigDefaults(e);this.config=i,this.gridTilemap=new hi(t),this.addCharacters()}getPosition(t){return this.geHeadless.getPosition(t)}move(t,e){this.geHeadless.move(t,e)}moveRandomly(t,e=0,i=-1){this.geHeadless.moveRandomly(t,e,i)}getMovement(t){return this.geHeadless.getMovement(t)}moveTo(t,e,i){return this.geHeadless.moveTo(t,e,i)}stopMovement(t){this.geHeadless.stopMovement(t)}setSpeed(t,e){this.geHeadless.setSpeed(t,e)}getSpeed(t){return this.geHeadless.getSpeed(t)}setContainer(t,e){var s;this.initGuard();let i=(s=this.gridCharacters)==null?void 0:s.get(t);if(!i)throw this.createCharUnknownErr(t);i.setContainer(e)}getContainer(t){var i;this.initGuard();let e=(i=this.gridCharacters)==null?void 0:i.get(t);if(!e)throw this.createCharUnknownErr(t);return e.getContainer()}getOffsetX(t){var i;this.initGuard();let e=(i=this.gridCharacters)==null?void 0:i.get(t);if(!e)throw this.createCharUnknownErr(t);return e.getOffsetX()}setOffsetX(t,e){var s;this.initGuard();let i=(s=this.gridCharacters)==null?void 0:s.get(t);if(!i)throw this.createCharUnknownErr(t);i.setOffsetX(e)}getOffsetY(t){var i;this.initGuard();let e=(i=this.gridCharacters)==null?void 0:i.get(t);if(!e)throw this.createCharUnknownErr(t);return e.getOffsetY()}setOffsetY(t,e){var s;this.initGuard();let i=(s=this.gridCharacters)==null?void 0:s.get(t);if(!i)throw this.createCharUnknownErr(t);i.setOffsetY(e)}getDepthOffset(t){var i;this.initGuard();let e=(i=this.gridCharacters)==null?void 0:i.get(t);if(!e)throw this.createCharUnknownErr(t);return e.getDepthOffset()}collidesWithTiles(t){return this.geHeadless.collidesWithTiles(t)}getWalkingAnimationMapping(t){var s;this.initGuard();let e=(s=this.gridCharacters)==null?void 0:s.get(t);if(!e)throw this.createCharUnknownErr(t);let i=e.getAnimation();return i==null?void 0:i.getWalkingAnimationMapping()}hasLayerOverlay(){var t;return this.initGuard(),!!((t=this.config)!=null&&t.layerOverlay)}setWalkingAnimationMapping(t,e){var a;this.initGuard();let i=(a=this.gridCharacters)==null?void 0:a.get(t);if(!i)throw this.createCharUnknownErr(t);let s=i.getAnimation();s==null||s.setWalkingAnimationMapping(e)}update(t,e){if(this.isCreatedInternal&&this.gridCharacters)for(let[i,s]of this.gridCharacters)s.update(e);this.geHeadless.update(t,e)}addCharacter(t){this.geHeadless.addCharacter(t),this.addCharacterInternal(t)}hasCharacter(t){return this.geHeadless.hasCharacter(t)}removeCharacter(t){var i,s;this.initGuard();let e=(i=this.gridCharacters)==null?void 0:i.get(t);if(!e)throw this.createCharUnknownErr(t);e.destroy(),(s=this.gridCharacters)==null||s.delete(t),this.geHeadless.removeCharacter(t)}removeAllCharacters(){if(this.initGuard(),!!this.gridCharacters){for(let t of this.gridCharacters.keys())this.removeCharacter(t);this.geHeadless.removeAllCharacters()}}getAllCharacters(t){return this.geHeadless.getAllCharacters(t)}getLabels(t){return this.geHeadless.getLabels(t)}addLabels(t,e){this.geHeadless.addLabels(t,e)}removeLabels(t,e){this.geHeadless.removeLabels(t,e)}clearLabels(t){this.geHeadless.clearLabels(t)}follow(t,e,i,s){let a;i===void 0?a={distance:0,closestPointIfBlocked:!1}:typeof i=="number"?(a={distance:i,closestPointIfBlocked:!1},s&&(a.closestPointIfBlocked=!0)):a=i,this.geHeadless.follow(t,e,a)}isMoving(t){return this.geHeadless.isMoving(t)}getFacingDirection(t){return this.geHeadless.getFacingDirection(t)}getFacingPosition(t){return this.geHeadless.getFacingPosition(t)}turnTowards(t,e){var s;this.initGuard();let i=(s=this.gridCharacters)==null?void 0:s.get(t);if(!i)throw this.createCharUnknownErr(t);i.turnTowards(e),this.geHeadless.turnTowards(t,e)}getCharactersAt(t,e){return this.geHeadless.getCharactersAt(t,e)}setPosition(t,e,i){this.geHeadless.setPosition(t,e,i)}getSprite(t){var i;this.initGuard();let e=(i=this.gridCharacters)==null?void 0:i.get(t);if(!e)throw this.createCharUnknownErr(t);return e.getSprite()}setSprite(t,e){var s;this.initGuard();let i=(s=this.gridCharacters)==null?void 0:s.get(t);if(!i)throw this.createCharUnknownErr(t);e.setOrigin(0,0),i.setSprite(e)}isBlocked(t,e,i=["geDefault"]){return this.geHeadless.isBlocked(t,e,i)}isTileBlocked(t,e){return this.geHeadless.isTileBlocked(t,e)}getCollisionGroups(t){return this.geHeadless.getCollisionGroups(t)}setCollisionGroups(t,e){this.geHeadless.setCollisionGroups(t,e)}getIgnoreCollisionGroups(t){return this.geHeadless.getIgnoreCollisionGroups(t)}setIgnoreCollisionGroups(t,e){this.geHeadless.setIgnoreCollisionGroups(t,e)}getTilePosInDirection(t,e,i){return this.geHeadless.getTilePosInDirection(t,e,i)}findShortestPath(t,e,i={}){return this.geHeadless.findShortestPath(t,e,i)}steppedOn(t,e,i){return this.geHeadless.steppedOn(t,e,i)}characterShifted(){return this.geHeadless.characterShifted()}movementStarted(){return this.geHeadless.movementStarted()}movementStopped(){return this.geHeadless.movementStopped()}directionChanged(){return this.geHeadless.directionChanged()}positionChangeStarted(){return this.geHeadless.positionChangeStarted()}positionChangeFinished(){return this.geHeadless.positionChangeFinished()}getMovementProgress(t){return this.geHeadless.getMovementProgress(t)}rebuildTileCollisionCache(t,e,i,s){this.geHeadless.rebuildTileCollisionCache(t,e,i,s)}addQueueMovements(t,e,i){this.geHeadless.addQueueMovements(t,e,i)}getEnqueuedMovements(t){return this.geHeadless.getEnqueuedMovements(t)}queueMovementFinished(){return this.geHeadless.queueMovementFinished()}clearEnqueuedMovements(t){return this.geHeadless.clearEnqueuedMovements(t)}getState(){return{characters:this.geHeadless.getState().characters.map(t=>we(it({},t),{offsetX:this.getOffsetX(t.id),offsetY:this.getOffsetY(t.id)}))}}setState(t){if(this.geHeadless.setState(t),this.gridCharacters)for(let e of t.characters){let i=this.gridCharacters.get(e.id);i&&(i.setOffsetX(e.offsetX),i.setOffsetY(e.offsetY))}}getTileCost(t,e,i){return this.initGuard(),this.geHeadless.getTileCost(t,e,i)}revertCurrentMovement(t){this.geHeadless.revertCurrentMovement(t)}isCurrentMovementReverted(t){return this.geHeadless.isCurrentMovementReverted(t)}setConfigDefaults(t){return it({collisionTilePropertyName:"ge_collide",numberOfDirections:4,characterCollisionStrategy:"BLOCK_TWO_TILES",layerOverlay:!1,cacheTileCollisions:!1},t)}initGuard(){if(!this.isCreatedInternal)throw this.createUninitializedErr()}createUninitializedErr(){throw new Error("GridEngine not initialized. You need to call create() first.")}addCharacters(){var t;(t=this.config)==null||t.characters.forEach(e=>this.addCharacterInternal(e))}createCharUnknownErr(t){return new Error(`Character unknown: ${t}`)}addCharacterInternal(t){var i;if(this.initGuard(),!this.gridTilemap)throw this.createUninitializedErr();if(!this.config)throw this.createUninitializedErr();let e=new ls(t,this.scene,this.gridTilemap,this.config.layerOverlay,this.geHeadless);(i=this.gridCharacters)==null||i.set(t.id,e)}};Un.welcomeMessagePrinted=!1;var Hs=Un;var ID=Hs;export{ch as ArrayTilemap,sh as CharacterShiftAction,cs as CollisionStrategy,le as Direction,Hs as GridEngine,Ns as GridEngineHeadless,ah as MoveToResult,Fi as NoPathFoundStrategy,Ii as NumberOfDirections,On as PathBlockedStrategy,di as PhaserTile,Nn as PhaserTileLayer,Us as PhaserTilemap,Zm as QueuedPathBlockedStrategy,Gn as TiledLayer,jn as TiledTile,mh as TiledTilemap,ID as default,Bt as directionFromPos};
